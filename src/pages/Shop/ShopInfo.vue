   ...
   <section class="section">
    ...
    <div class="delivery">
     <div>
      ...
      <span>由商家配送提供配送，约{{info.minPrice}}分钟送达，距离{{info.distance}}</span>
     </div>
  ...
  export default{
     ...
     mounted () {
      ...
      new BScroll(this.$refs.shopinfo, {
       ...
       const div=this.$refs.pics
        const liwidth =120
        const  space=6 //边距
        const count =this.info.pics.length //个数
        const width =(liwidth+space)*count
       div.style.width=width +'px'
       //       const width =120
//       const item =6
//       const UL =this.info.pics.length
